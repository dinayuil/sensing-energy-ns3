...
class LoraRadioEnergyModel : public DeviceEnergyModel
{
  public:
    ...
    /**
     * Sets the fixed charge overhead per reception.
     *
     * @param charge The fixed charge overhead per reception [Coulombs].
     */
    void SetRxOverheadCharge(double charge);

    /**
     * Gets the fixed charge overhead per reception.
     *
     * @return The fixed charge overhead per reception [Coulombs].
     */
    double GetRxOverheadCharge() const;

    /**
     * Sets the fixed charge overhead per standby transition.
     *
     * @param charge The fixed charge overhead per standby transition [Coulombs].
     */
    void SetStandbyOverheadCharge(double charge);

    /**
     * Gets the fixed charge overhead per standby transition.
     *
     * @return The fixed charge overhead per standby transition [Coulombs].
     */
    double GetStandbyOverheadCharge() const;
  ...
  private:
    ...
    double m_rxOverheadCharge;       ///< The fixed charge overhead per reception [Coulombs]
    double m_standbyOverheadCharge;  ///< The fixed charge overhead per standby transition [Coulombs]
    // NOTICE VERY WELL: Current  Model linear or constant as possible choices
